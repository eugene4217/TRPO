...
uses
  ...
  Dialogs, Grids, Buttons, StdCtrls, Spin, Vcl.Menus, ShellAPI;
...
uses Unit7, Unit10, Unit12, Unit6, Unit13;
var a:ta;
t:cardinal;
exitclick:boolean;
co:cardinal;
...
procedure TForm1.Draw(var a:ta);//рисование нашего ферз€ в €чейке
var i:integer;
begin
...
procedure TForm1.BackTracking(k:integer;a:ta);//основна€ процедура,расчЄт
var i,j:integer;
po:boolean;
b:ta;
begin
...
procedure TForm1.SpeedButton1Click(Sender: TObject);//запуск подсчЄта
begin
co:=0;
exitclick:=false;
...
procedure TForm1.FormCreate(Sender: TObject);//подготовка к работе(стартова€ инициализаци€)
begin
