...
0: AssignFile( f ,'D:\Учёба\ОАиП\Лабораторные работы\Тест\variant1.txt', CP_UTF8);//связывается с разными файлами
1: AssignFile( f ,'D:\Учёба\ОАиП\Лабораторные работы\Тест\variant2.txt', CP_UTF8);
end;
