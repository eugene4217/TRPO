...
0: AssignFile( f,'C:\Users\Женя\Desktop\Курсовая работа\Проект\Тесты\variant1.txt', CP_UTF8);//связывается с разными файлами
1: AssignFile( f,'C:\Users\Женя\Desktop\Курсовая работа\Проект\Тесты\variant2.txt', CP_UTF8);
end;
